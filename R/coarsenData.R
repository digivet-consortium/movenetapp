  ...
  tagList(
    ...
    fluidRow(
      column(6,
             ...
             numericInput(ns("jitter_d_4"), label = NULL, min=0, value = NULL),
             numericInput(ns("jitter_d_5"), label = NULL, min=0, value = NULL),
      ...
      column(6,
             ...
             selectInput(ns("rounding_units_d"), "Time unit(s) to round dates down to",
                         choices = list("No rounding" = "", "week", "month",
             ...
             checkboxInput(ns("sum_weight"), "Aggregate movement weights",
                           value = TRUE),
    ...
    function(input, output, session) {
      ...
      observeEvent(input$modify_data, {
        ...
        jitter_d_set <- rep(c(input$jitter_d_1, input$jitter_d_2,
                              input$jitter_d_3, input$jitter_d_4,
                              input$jitter_d_5), input$jitter_d_sims)
